...
typedef struct SystemeCordeT systemeCordeT;
	struct SystemeCordeT
		{
...
void systemeInitialise(systemeCordeT * systeme);
void systemeAffiche(systemeCordeT * systeme);

// évolution temporelle du système, "duree" cycle d'évolution
void systemeEvolution(systemeCordeT * systeme, int duree);
