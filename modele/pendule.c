...
double penduleGravitation(penduleT * pendule, int choix);
	// dt * vitesse du pendule
double penduleVitesse(penduleT * pendule);
	// Somme des forces
double penduleForces(penduleT * pendule, int choix, float courantJosephson);
...
void penduleInertie(penduleT * pendule, int choix, float courantJosephson)
	...
	(*pendule).nouveau = penduleForces(pendule, choix, courantJosephson) + 2*((*pendule).actuel) - (*pendule).ancien;
	return;
	}
...
double penduleForces(penduleT * pendule, int choix, float courantJosephson)
	...
	return ((*pendule).forceCouplage + penduleGravitation(pendule, choix) + ((*pendule).alpha)*penduleVitesse(pendule) + courantJosephson);
	}
